...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    private void wireWidgets() {
        editTextName = findViewById(R.id.edittext_name_createaccount);
        editTextUsername = findViewById(R.id.edittext_username_createaccount);
        editTextPassword = findViewById(R.id.edittext_pass_createaccount);
        editTextConfirmPassword = findViewById(R.id.editText_confirmpass_createaccount);
        editTextEmail = findViewById(R.id.editText_email_createaccount);
        buttonCreate = findViewById(R.id.button_createaccount_createaccount);
    }
}
